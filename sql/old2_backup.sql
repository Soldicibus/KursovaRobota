...
SELECT pg_catalog.setval('public.homework_homework_id_seq', 126, true);
...
SELECT pg_catalog.setval('public.lessons_lesson_id_seq', 195, true);
...
SELECT pg_catalog.setval('public.studentdata_data_id_seq', 1497, true);
...
ALTER TABLE ONLY public.timetable
    ADD CONSTRAINT timetable_timetable_class_fkey FOREIGN KEY (timetable_class) REFERENCES public.class(class_name) ON DELETE SET NULL;
