...
\restrict pfl1dkHxTipayPwvO7v4HLO94izEdazeW9Eaf4TXW5N3t4IDTteukIMIevF15Ue
...
CREATE PROCEDURE public.proc_create_lesson(INOUT p_name character varying, IN p_class character varying, IN p_subject integer, INOUT p_material integer, IN p_teacher integer, INOUT p_date timestamp without time zone, OUT new_lesson_id integer)
    LANGUAGE plpgsql
    AS $_$
BEGIN
    p_name := NULLIF(trim(p_name), '');
...
ALTER PROCEDURE public.proc_create_lesson(INOUT p_name character varying, IN p_class character varying, IN p_subject integer, INOUT p_material integer, IN p_teacher integer, INOUT p_date timestamp without time zone, OUT new_lesson_id integer) OWNER TO postgres;
...
127	Pickers	34	1	2025-12-24	2025-12-23	asd	12-Г
35	FAAAAAAAAAAAAAAAAAAA	1	14	2025-12-23	2025-09-24	ASSSSSSSS	2-Б
129	asd	1	215	2026-01-01	2025-12-23	asd	1-А
131	SHITTYTIME	7	1	2025-12-23	2025-12-23	ASS SHITTING	5-Б
130	GET YOUR ASS HERE!	1	217	2026-05-31	2025-12-23	DEFECATE THROUGH THE SUNROOF!THATS IT YOU FAAAAAAAAAAAAAA, NOONE DID SHYEEEEEET\n\nWHAT IS DIS?!?! WAD IS WRANG WIT UUU?!?	6-Б
\.
...
201	Математика:3	1-А	1	1	1	2025-12-24 23:00:00
202	B-ASS	2-Б	10	62	1	2025-12-23 13:43:00
203	B-ASS	1-А	10	122	1	2025-12-26 13:48:00
204	B-ASS	1-А	10	122	1	2025-12-25 13:48:00
205	B-ASS	1-А	10	122	1	2555-12-25 13:48:00
207	B-ASS	1-А	10	122	1	2550-12-25 15:48:00
208	B-ASS	1-А	10	122	1	2550-12-25 19:48:00
209	B-ASS	1-А	10	122	1	2550-12-25 12:48:00
211	B-ASS	1-А	10	122	1	2026-12-25 12:48:00
212	B-ASS	1-А	10	122	1	2026-01-25 12:48:00
214	B-ASS	1-А	10	122	1	2026-02-25 12:48:00
215	ASSS	1-А	1	1	1	2025-12-23 13:55:00
217	B-ASS	1-А	10	114	1	2026-12-23 14:02:00
\.
...
1498	1	1	201	12	П	Робота	2025-12-23 12:06:14.711716
1497	1	1	192	10	П	Гарна робота!	2025-12-23 11:45:42.259094
1499	1	1	215	12	П	12	2025-12-23 16:10:50.154005
1501	13	125	215	12	П	12	2025-12-23 16:40:41.197454
1504	5	41	215	1	Не присутній	1	2025-12-23 16:41:56.666895
1505	5	43	215	1	Не присутній	1	2025-12-23 16:42:07.002621
1509	5	42	215	1	Присутній	1	2025-12-23 16:43:23.792362
\.
...
SELECT pg_catalog.setval('public.homework_homework_id_seq', 131, true);
...
SELECT pg_catalog.setval('public.lessons_lesson_id_seq', 217, true);
...
SELECT pg_catalog.setval('public.studentdata_data_id_seq', 1509, true);
...
SELECT pg_catalog.setval('public.students_student_id_seq', 287, true);
...
SELECT pg_catalog.setval('public.users_user_id_seq', 836, true);
...
ALTER TABLE ONLY public.timetable
    ADD CONSTRAINT timetable_timetable_class_fkey FOREIGN KEY (timetable_class) REFERENCES public.class(class_name);
...
GRANT ALL ON FUNCTION public.absents_more_than_x(p_class character varying, p_x integer) TO sadmin;
...
GRANT ALL ON FUNCTION public.get_children_by_parent(p_parent_id integer) TO sadmin;
...
--
-- Name: FUNCTION get_student_grade_entries(p_student_id integer, p_start_date date, p_end_date date); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON FUNCTION public.get_student_grade_entries(p_student_id integer, p_start_date date, p_end_date date) FROM PUBLIC;
GRANT ALL ON FUNCTION public.get_student_grade_entries(p_student_id integer, p_start_date date, p_end_date date) TO student;
GRANT ALL ON FUNCTION public.get_student_grade_entries(p_student_id integer, p_start_date date, p_end_date date) TO admin;
GRANT ALL ON FUNCTION public.get_student_grade_entries(p_student_id integer, p_start_date date, p_end_date date) TO sadmin;
...
GRANT ALL ON FUNCTION public.get_student_marks(p_student_id integer, p_from date, p_to date) TO sadmin;
...
GRANT ALL ON FUNCTION public.get_teacher_salary(p_teacher_id integer, p_from date, p_to date) TO sadmin;
...
GRANT ALL ON FUNCTION public.get_user_role(p_user_id integer) TO sadmin;
...
GRANT ALL ON FUNCTION public.login_user(p_login text, p_password text) TO sadmin;
...
GRANT ALL ON PROCEDURE public.proc_create_day(IN p_subject integer, IN p_timetable integer, IN p_day_time time without time zone, IN p_day_weekday character varying, OUT new_day_id integer) TO sadmin;
...
REVOKE ALL ON PROCEDURE public.proc_create_lesson(INOUT p_name character varying, IN p_class character varying, IN p_subject integer, INOUT p_material integer, IN p_teacher integer, INOUT p_date date, OUT new_lesson_id integer) FROM PUBLIC;
...
GRANT ALL ON PROCEDURE public.proc_create_lesson(INOUT p_name character varying, IN p_class character varying, IN p_subject integer, INOUT p_material integer, IN p_teacher integer, INOUT p_date date, OUT new_lesson_id integer) TO teacher;


--
-- Name: PROCEDURE proc_create_lesson(INOUT p_name character varying, IN p_class character varying, IN p_subject integer, INOUT p_material integer, IN p_teacher integer, INOUT p_date timestamp without time zone, OUT new_lesson_id integer); Type: ACL; Schema: public; Owner: postgres
--

REVOKE ALL ON PROCEDURE public.proc_create_lesson(INOUT p_name character varying, IN p_class character varying, IN p_subject integer, INOUT p_material integer, IN p_teacher integer, INOUT p_date timestamp without time zone, OUT new_lesson_id integer) FROM PUBLIC;
GRANT ALL ON PROCEDURE public.proc_create_lesson(INOUT p_name character varying, IN p_class character varying, IN p_subject integer, INOUT p_material integer, IN p_teacher integer, INOUT p_date timestamp without time zone, OUT new_lesson_id integer) TO sadmin;
...
GRANT ALL ON PROCEDURE public.proc_delete_material(IN p_id integer) TO sadmin;
...
GRANT ALL ON PROCEDURE public.proc_delete_teacher(IN p_id integer) TO sadmin;
...
GRANT ALL ON PROCEDURE public.proc_register_user(IN p_username character varying, IN p_email character varying, IN p_password text, OUT new_user_id integer) TO sadmin;
...
GRANT ALL ON PROCEDURE public.proc_reset_user_password(IN p_user_id integer, IN p_new_password character varying) TO guest;
...
GRANT ALL ON PROCEDURE public.proc_update_day(IN p_id integer, IN p_subject integer, IN p_timetable integer, IN p_time time without time zone, IN p_weekday character varying) TO sadmin;
...
REVOKE ALL ON PROCEDURE public.proc_update_lesson(IN p_lesson_id integer, IN p_name character varying, IN p_class character varying, IN p_subject integer, IN p_material integer, IN p_teacher integer, IN p_date date) FROM PUBLIC;
...
GRANT ALL ON FUNCTION public.student_attendance_report(p_student_id integer, p_from date, p_to date) TO sadmin;
...
GRANT ALL ON FUNCTION public.student_day_plan(p_student_id integer, p_date date) TO sadmin;
...
GRANT ALL ON FUNCTION public.translit_uk_to_lat(p_text text) TO sadmin;
...
\unrestrict pfl1dkHxTipayPwvO7v4HLO94izEdazeW9Eaf4TXW5N3t4IDTteukIMIevF15Ue
