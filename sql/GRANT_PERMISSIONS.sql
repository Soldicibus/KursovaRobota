...
-- GRANT EXECUTE ON PROCEDURE proc_update_lesson(...) TO admin;
-- GRANT EXECUTE ON PROCEDURE proc_delete_lesson(...) TO admin;
-- Homework
...
-- Role Management
REVOKE EXECUTE ON PROCEDURE proc_assign_role_to_user(INT, INT) TO admin;
REVOKE EXECUTE ON PROCEDURE proc_remove_role_from_user(INT, INT) TO admin;
...
-- Note: proc_delete_user not in file list but implied by "User Creation/Deletion"
-- GRANT EXECUTE ON PROCEDURE proc_delete_user(INT) TO sadmin;
