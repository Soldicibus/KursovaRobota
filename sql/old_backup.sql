...
\restrict Cdp7ZaKkeew7cmL0MoEf7NxAra8ukLtkdzlEbKuKAlGMy1qWGTbQPh6Q48TAcuA

-- Dumped from database version 17.6
-- Dumped by pg_dump version 17.6

-- Started on 2025-12-18 20:15:07
...
--
-- TOC entry 935 (class 1247 OID 43871)
...
--
-- TOC entry 258 (class 1255 OID 43879)
...
--
-- TOC entry 262 (class 1255 OID 44272)
...
--
-- TOC entry 317 (class 1255 OID 44323)
-- Name: get_data_by_user_id(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_data_by_user_id(p_user_id integer) RETURNS TABLE(role text, entity_id integer, name character varying, surname character varying, email character varying, phone character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
    -- STUDENT
...
--
-- TOC entry 259 (class 1255 OID 43881)
...
--
-- TOC entry 260 (class 1255 OID 43882)
...
--
-- TOC entry 316 (class 1255 OID 44273)
-- Name: get_student_grade_entries(integer, date, date); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_student_grade_entries(p_student_id integer, p_start_date date DEFAULT ((CURRENT_DATE - '2 days'::interval))::date, p_end_date date DEFAULT ((CURRENT_DATE + '7 days'::interval))::date) RETURNS TABLE(lesson_date date, subject_name text, mark smallint, status text)
    LANGUAGE sql
    AS $$
    SELECT
        l.lesson_date,
...
ALTER FUNCTION public.get_student_grade_entries(p_student_id integer, p_start_date date, p_end_date date) OWNER TO postgres;

--
-- TOC entry 261 (class 1255 OID 43883)
-- Name: get_student_grades_and_absences(integer, date, date); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_student_grades_and_absences(p_student_id integer, p_start_date date, p_end_date date) RETURNS TABLE(subject_name text, avg_mark numeric, absences integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
    SELECT 
        ...
        COUNT(*) FILTER (WHERE sd.status = 'Н')::INT AS absences
    FROM StudentData sd
    JOIN Lessons l ON sd.lesson = l.lesson_id
    JOIN Subjects s ON l.lesson_subject = s.subject_id
    WHERE sd.student_id = p_student_id
...
ALTER FUNCTION public.get_student_grades_and_absences(p_student_id integer, p_start_date date, p_end_date date) OWNER TO postgres;

--
-- TOC entry 314 (class 1255 OID 44321)
...
--
-- TOC entry 275 (class 1255 OID 43885)
...
--
-- TOC entry 280 (class 1255 OID 44335)
...
--
-- TOC entry 276 (class 1255 OID 43886)
...
--
-- TOC entry 277 (class 1255 OID 43887)
...
--
-- TOC entry 288 (class 1255 OID 43888)
...
--
-- TOC entry 296 (class 1255 OID 43889)
...
--
-- TOC entry 278 (class 1255 OID 43890)
...
--
-- TOC entry 311 (class 1255 OID 43891)
-- Name: proc_create_day(character varying, time without time zone, character varying); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.proc_create_day(IN p_day_name character varying, IN p_day_time time without time zone, IN p_day_weekday character varying, OUT new_day_id integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER PROCEDURE public.proc_create_day(IN p_day_name character varying, IN p_day_time time without time zone, IN p_day_weekday character varying, OUT new_day_id integer) OWNER TO postgres;

--
-- TOC entry 303 (class 1255 OID 43892)
...
--
-- TOC entry 300 (class 1255 OID 43893)
...
--
-- TOC entry 309 (class 1255 OID 43894)
...
--
-- TOC entry 293 (class 1255 OID 43895)
...
CREATE PROCEDURE public.proc_create_parent(IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, OUT new_parent_id integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    p_name := NULLIF(trim(p_name), '');
...
ALTER PROCEDURE public.proc_create_parent(IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, OUT new_parent_id integer) OWNER TO postgres;

--
-- TOC entry 290 (class 1255 OID 43896)
...
CREATE PROCEDURE public.proc_create_student(IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, IN p_class character varying, OUT new_student_id integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    p_name := NULLIF(trim(p_name), '');
    ...
    RETURNING sudent_id INTO new_student_id;
END;
$$;


ALTER PROCEDURE public.proc_create_student(IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, IN p_class character varying, OUT new_student_id integer) OWNER TO postgres;

--
-- TOC entry 306 (class 1255 OID 43897)
...
--
-- TOC entry 298 (class 1255 OID 43898)
...
--
-- TOC entry 285 (class 1255 OID 43899)
...
--
-- TOC entry 313 (class 1255 OID 43900)
...
--
-- TOC entry 305 (class 1255 OID 43901)
...
--
-- TOC entry 302 (class 1255 OID 43902)
...
--
-- TOC entry 295 (class 1255 OID 43903)
...
--
-- TOC entry 292 (class 1255 OID 43904)
...
--
-- TOC entry 308 (class 1255 OID 43905)
...
--
-- TOC entry 281 (class 1255 OID 43906)
...
--
-- TOC entry 282 (class 1255 OID 43907)
...
--
-- TOC entry 289 (class 1255 OID 43908)
...
--
-- TOC entry 287 (class 1255 OID 43909)
...
--
-- TOC entry 297 (class 1255 OID 43910)
...
--
-- TOC entry 312 (class 1255 OID 43911)
-- Name: proc_update_day(integer, character varying, time without time zone, character varying); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.proc_update_day(IN p_id integer, IN p_name character varying DEFAULT NULL::character varying, IN p_time time without time zone DEFAULT NULL::time without time zone, IN p_weekday character varying DEFAULT NULL::character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
    IF NOT EXISTS (
...
ALTER PROCEDURE public.proc_update_day(IN p_id integer, IN p_name character varying, IN p_time time without time zone, IN p_weekday character varying) OWNER TO postgres;

--
-- TOC entry 304 (class 1255 OID 43912)
...
--
-- TOC entry 301 (class 1255 OID 43913)
...
ALTER PROCEDURE public.proc_update_lesson(IN p_lesson_id integer, IN p_name character varying, IN p_class character varying, IN p_subject integer, IN p_material integer, IN p_teacher integer, IN p_date date) OWNER TO postgres;

--
-- TOC entry 310 (class 1255 OID 43914)
...
--
-- TOC entry 294 (class 1255 OID 43915)
...
--
-- TOC entry 291 (class 1255 OID 43916)
...
--
-- TOC entry 307 (class 1255 OID 43917)
...
--
-- TOC entry 299 (class 1255 OID 43918)
...
--
-- TOC entry 286 (class 1255 OID 43919)
...
--
-- TOC entry 284 (class 1255 OID 43920)
...
BEGIN
    ...
    SELECT
        ...
        ROUND(
            COUNT(*) FILTER (WHERE sd.status IN ('П','Присутній'))::NUMERIC
            / total * 100,
            2
        )
    FROM StudentData sd
...
--
-- TOC entry 315 (class 1255 OID 44322)
...
--
-- TOC entry 283 (class 1255 OID 43922)
...
--
-- TOC entry 273 (class 1255 OID 43923)
...
--
-- TOC entry 279 (class 1255 OID 43924)
...
--
-- TOC entry 217 (class 1259 OID 43925)
...
--
-- TOC entry 218 (class 1259 OID 43929)
...
--
-- TOC entry 219 (class 1259 OID 43933)
...
--
-- TOC entry 220 (class 1259 OID 43934)
...
--
-- TOC entry 221 (class 1259 OID 43941)
...
--
-- TOC entry 222 (class 1259 OID 43942)
-- Name: homework_tomorrow; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.homework_tomorrow AS
 SELECT homework_id,
    homework_name,
    homework_teacher,
    homework_lesson,
...
ALTER VIEW public.homework_tomorrow OWNER TO postgres;

--
-- TOC entry 223 (class 1259 OID 43946)
-- Name: journal; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.journal (
    journal_id integer NOT NULL,
    journal_teacher integer NOT NULL,
...
--
-- TOC entry 224 (class 1259 OID 43949)
...
--
-- TOC entry 225 (class 1259 OID 43950)
...
--
-- TOC entry 226 (class 1259 OID 43954)
...
--
-- TOC entry 227 (class 1259 OID 43955)
...
--
-- TOC entry 228 (class 1259 OID 43960)
...
--
-- TOC entry 229 (class 1259 OID 43961)
...
--
-- TOC entry 230 (class 1259 OID 43964)
...
--
-- TOC entry 231 (class 1259 OID 43965)
...
--
-- TOC entry 232 (class 1259 OID 43970)
...
--
-- TOC entry 233 (class 1259 OID 43971)
...
--
-- TOC entry 234 (class 1259 OID 43978)
...
--
-- TOC entry 235 (class 1259 OID 43979)
...
--
-- TOC entry 236 (class 1259 OID 43982)
...
--
-- TOC entry 237 (class 1259 OID 43986)
-- Name: students_avg_above_7; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.students_avg_above_7 AS
 SELECT s.student_id,
...
ALTER VIEW public.students_avg_above_7 OWNER TO postgres;

--
-- TOC entry 238 (class 1259 OID 43991)
-- Name: students_by_class; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.students_by_class AS
 SELECT student_name,
    student_class
   FROM public.students;


ALTER VIEW public.students_by_class OWNER TO postgres;

--
-- TOC entry 239 (class 1259 OID 43995)
...
--
-- TOC entry 240 (class 1259 OID 43996)
...
--
-- TOC entry 241 (class 1259 OID 44001)
...
--
-- TOC entry 242 (class 1259 OID 44002)
...
--
-- TOC entry 243 (class 1259 OID 44006)
...
--
-- TOC entry 244 (class 1259 OID 44007)
-- Name: teachers_with_classes; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.teachers_with_classes AS
...
ALTER VIEW public.teachers_with_classes OWNER TO postgres;

--
-- TOC entry 245 (class 1259 OID 44011)
...
--
-- TOC entry 246 (class 1259 OID 44015)
...
--
-- TOC entry 247 (class 1259 OID 44016)
...
--
-- TOC entry 248 (class 1259 OID 44019)
...
--
-- TOC entry 249 (class 1259 OID 44025)
...
--
-- TOC entry 250 (class 1259 OID 44026)
...
--
-- TOC entry 251 (class 1259 OID 44031)
...
--
-- TOC entry 255 (class 1259 OID 44302)
...
--
-- TOC entry 252 (class 1259 OID 44040)
...
--
-- TOC entry 256 (class 1259 OID 44315)
...
--
-- TOC entry 253 (class 1259 OID 44049)
...
--
-- TOC entry 254 (class 1259 OID 44054)
...
--
-- TOC entry 5061 (class 0 OID 43925)
-- Dependencies: 217
...
--
-- TOC entry 5062 (class 0 OID 43929)
-- Dependencies: 218
...
--
-- TOC entry 5064 (class 0 OID 43934)
-- Dependencies: 220
...
--
-- TOC entry 5066 (class 0 OID 43946)
-- Dependencies: 223
...
--
-- TOC entry 5068 (class 0 OID 43950)
-- Dependencies: 225
...
--
-- TOC entry 5070 (class 0 OID 43955)
-- Dependencies: 227
...
--
-- TOC entry 5072 (class 0 OID 43961)
-- Dependencies: 229
...
11	Геннадій	Козак	Романович	068-002-2010	11
...
--
-- TOC entry 5074 (class 0 OID 43965)
-- Dependencies: 231
...
3	Moderator	Moderator is responsible for the actions of all users.
4	Student	Students are studying in the school, their prime responsibilities are to keep up with homework.
5	Starosta	Starosta is a student that has more responsibilities, he might help the teacher with managing student abscenses.
...
--
-- TOC entry 5076 (class 0 OID 43971)
-- Dependencies: 233
...
1	1	1	1	\N	Присутній	\N	2025-12-14 22:17:43.36063
...
--
-- TOC entry 5078 (class 0 OID 43979)
-- Dependencies: 235
...
--
-- TOC entry 5079 (class 0 OID 43982)
-- Dependencies: 236
...
1	Артем	Шевченко	Сергійович	067-001-1000	787	1-А
...
--
-- TOC entry 5081 (class 0 OID 43996)
-- Dependencies: 240
-- Data for Name: subjects; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.subjects (subject_id, subject_name, subject_program) FROM stdin;
1	Математика	\N
2	Українська мова	\N
3	Українська література	\N
4	Фізика	\N
5	Хімія	\N
6	Біологія	\N
7	Географія	\N
...
13	Інформатика	\N
14	Технології	\N
15	Історія України	\N
16	Алгебра	\N
17	Геометрія	\N
18	Екологія	\N
19	Економіка	\N
20	Всесвітня Історія	\N
\.


--
-- TOC entry 5083 (class 0 OID 44002)
-- Dependencies: 242
...
1	Олександр	Шевченко	Іванович	039-123-4501	\N
...
--
-- TOC entry 5085 (class 0 OID 44011)
-- Dependencies: 245
...
--
-- TOC entry 5087 (class 0 OID 44016)
-- Dependencies: 247
...
--
-- TOC entry 5088 (class 0 OID 44019)
-- Dependencies: 248
...
SELECT pg_catalog.setval('public.days_day_id_seq', 700, true);
...
SELECT pg_catalog.setval('public.homework_homework_id_seq', 121, true);
...
SELECT pg_catalog.setval('public.journal_journal_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.lessons_lesson_id_seq', 171, true);
...
SELECT pg_catalog.setval('public.material_material_id_seq', 124, true);
...
SELECT pg_catalog.setval('public.parents_parent_id_seq', 467, true);
...
SELECT pg_catalog.setval('public.studentdata_data_id_seq', 1490, true);
...
SELECT pg_catalog.setval('public.students_student_id_seq', 280, true);
...
SELECT pg_catalog.setval('public.teacher_teacher_id_seq', 36, true);
...
SELECT pg_catalog.setval('public.timetable_timetable_id_seq', 28, true);
...
SELECT pg_catalog.setval('public.users_user_id_seq', 787, true);


--
-- TOC entry 4825 (class 2606 OID 44063)
...
--
-- TOC entry 4827 (class 2606 OID 44065)
...
--
-- TOC entry 4829 (class 2606 OID 44067)
...
--
-- TOC entry 4831 (class 2606 OID 44069)
...
--
-- TOC entry 4833 (class 2606 OID 44071)
...
--
-- TOC entry 4835 (class 2606 OID 44073)
...
--
-- TOC entry 4837 (class 2606 OID 44075)
...
--
-- TOC entry 4839 (class 2606 OID 44077)
...
--
-- TOC entry 4841 (class 2606 OID 44079)
...
--
-- TOC entry 4843 (class 2606 OID 44081)
...
--
-- TOC entry 4845 (class 2606 OID 44083)
...
--
-- TOC entry 4847 (class 2606 OID 44085)
...
--
-- TOC entry 4849 (class 2606 OID 44087)
...
--
-- TOC entry 4851 (class 2606 OID 44089)
...
--
-- TOC entry 4853 (class 2606 OID 44091)
...
--
-- TOC entry 4855 (class 2606 OID 44093)
...
--
-- TOC entry 4857 (class 2606 OID 44095)
...
--
-- TOC entry 4859 (class 2606 OID 44097)
...
--
-- TOC entry 4861 (class 2606 OID 44099)
...
--
-- TOC entry 4863 (class 2606 OID 44101)
...
--
-- TOC entry 4865 (class 2606 OID 44103)
...
--
-- TOC entry 4867 (class 2606 OID 44105)
...
--
-- TOC entry 4869 (class 2606 OID 44107)
...
--
-- TOC entry 4871 (class 2606 OID 44109)
...
--
-- TOC entry 4873 (class 2606 OID 44111)
...
--
-- TOC entry 4875 (class 2606 OID 44113)
...
--
-- TOC entry 4877 (class 2606 OID 44115)
...
--
-- TOC entry 5059 (class 2618 OID 44318)
...
--
-- TOC entry 4901 (class 2620 OID 44116)
...
--
-- TOC entry 4902 (class 2620 OID 44117)
...
--
-- TOC entry 4903 (class 2620 OID 44118)
...
--
-- TOC entry 4878 (class 2606 OID 44119)
-- Name: class class_class_journal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.class
    ADD CONSTRAINT class_class_journal_id_fkey FOREIGN KEY (class_journal_id) REFERENCES public.journal(journal_id);


--
-- TOC entry 4879 (class 2606 OID 44124)
-- Name: class class_class_mainteacher_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.class
    ADD CONSTRAINT class_class_mainteacher_fkey FOREIGN KEY (class_mainteacher) REFERENCES public.teacher(teacher_id);


--
-- TOC entry 4880 (class 2606 OID 44129)
-- Name: days days_day_subject_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.days
    ADD CONSTRAINT days_day_subject_fkey FOREIGN KEY (day_subject) REFERENCES public.subjects(subject_id);


--
-- TOC entry 4881 (class 2606 OID 44134)
-- Name: days days_day_timetable_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.days
    ADD CONSTRAINT days_day_timetable_fkey FOREIGN KEY (day_timetable) REFERENCES public.timetable(timetable_id);


--
-- TOC entry 4882 (class 2606 OID 44139)
-- Name: homework homework_homework_class_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.homework
    ADD CONSTRAINT homework_homework_class_fkey FOREIGN KEY (homework_class) REFERENCES public.class(class_name);


--
-- TOC entry 4883 (class 2606 OID 44144)
-- Name: homework homework_homework_lesson_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.homework
    ADD CONSTRAINT homework_homework_lesson_fkey FOREIGN KEY (homework_lesson) REFERENCES public.lessons(lesson_id);


--
-- TOC entry 4884 (class 2606 OID 44149)
-- Name: homework homework_homework_teacher_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.homework
    ADD CONSTRAINT homework_homework_teacher_fkey FOREIGN KEY (homework_teacher) REFERENCES public.teacher(teacher_id);


--
-- TOC entry 4885 (class 2606 OID 44154)
-- Name: journal journal_journal_teacher_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.journal
    ADD CONSTRAINT journal_journal_teacher_fkey FOREIGN KEY (journal_teacher) REFERENCES public.teacher(teacher_id);


--
-- TOC entry 4886 (class 2606 OID 44159)
-- Name: lessons lessons_lesson_class_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lessons
    ADD CONSTRAINT lessons_lesson_class_fkey FOREIGN KEY (lesson_class) REFERENCES public.class(class_name);


--
-- TOC entry 4887 (class 2606 OID 44164)
-- Name: lessons lessons_lesson_material_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lessons
    ADD CONSTRAINT lessons_lesson_material_fkey FOREIGN KEY (lesson_material) REFERENCES public.material(material_id);


--
-- TOC entry 4888 (class 2606 OID 44169)
-- Name: lessons lessons_lesson_subject_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lessons
    ADD CONSTRAINT lessons_lesson_subject_fkey FOREIGN KEY (lesson_subject) REFERENCES public.subjects(subject_id);


--
-- TOC entry 4889 (class 2606 OID 44174)
-- Name: lessons lessons_lesson_teacher_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.lessons
    ADD CONSTRAINT lessons_lesson_teacher_fkey FOREIGN KEY (lesson_teacher) REFERENCES public.teacher(teacher_id);


--
-- TOC entry 4890 (class 2606 OID 44179)
-- Name: parents parents_parent_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.parents
    ADD CONSTRAINT parents_parent_user_id_fkey FOREIGN KEY (parent_user_id) REFERENCES public.users(user_id);


--
-- TOC entry 4891 (class 2606 OID 44184)
-- Name: studentdata studentdata_journal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.studentdata
    ADD CONSTRAINT studentdata_journal_id_fkey FOREIGN KEY (journal_id) REFERENCES public.journal(journal_id);


--
-- TOC entry 4892 (class 2606 OID 44189)
-- Name: studentdata studentdata_lesson_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.studentdata
    ADD CONSTRAINT studentdata_lesson_fkey FOREIGN KEY (lesson) REFERENCES public.lessons(lesson_id);


--
-- TOC entry 4893 (class 2606 OID 44194)
-- Name: studentdata studentdata_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.studentdata
    ADD CONSTRAINT studentdata_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(student_id);


--
-- TOC entry 4894 (class 2606 OID 44199)
-- Name: studentparent studentparent_parent_id_ref_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.studentparent
    ADD CONSTRAINT studentparent_parent_id_ref_fkey FOREIGN KEY (parent_id_ref) REFERENCES public.parents(parent_id);


--
-- TOC entry 4895 (class 2606 OID 44204)
-- Name: studentparent studentparent_student_id_ref_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.studentparent
    ADD CONSTRAINT studentparent_student_id_ref_fkey FOREIGN KEY (student_id_ref) REFERENCES public.students(student_id);


--
-- TOC entry 4896 (class 2606 OID 44209)
...
--
-- TOC entry 4897 (class 2606 OID 44214)
-- Name: students students_student_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.students
    ADD CONSTRAINT students_student_user_id_fkey FOREIGN KEY (student_user_id) REFERENCES public.users(user_id);


--
-- TOC entry 4898 (class 2606 OID 44219)
...
--
-- TOC entry 4899 (class 2606 OID 44224)
-- Name: userrole userrole_role_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.userrole
    ADD CONSTRAINT userrole_role_id_fkey FOREIGN KEY (role_id) REFERENCES public.roles(role_id);


--
-- TOC entry 4900 (class 2606 OID 44229)
-- Name: userrole userrole_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.userrole
    ADD CONSTRAINT userrole_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(user_id);
...
GRANT ALL ON PROCEDURE public.proc_assign_role_to_user(IN p_user_id integer, IN p_role_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_assign_student_parent(IN p_student_id integer, IN p_parent_id integer) TO superadmin;


--
-- TOC entry 5097 (class 0 OID 0)
-- Dependencies: 311
-- Name: PROCEDURE proc_create_day(IN p_day_name character varying, IN p_day_time time without time zone, IN p_day_weekday character varying, OUT new_day_id integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON PROCEDURE public.proc_create_day(IN p_day_name character varying, IN p_day_time time without time zone, IN p_day_weekday character varying, OUT new_day_id integer) TO admin;
GRANT ALL ON PROCEDURE public.proc_create_day(IN p_day_name character varying, IN p_day_time time without time zone, IN p_day_weekday character varying, OUT new_day_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_create_homework(INOUT p_name character varying, IN p_teacher integer, IN p_lesson integer, INOUT p_duedate date, INOUT p_desc text, IN p_class character varying, OUT new_homework_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_create_lesson(INOUT p_name character varying, IN p_class character varying, IN p_subject integer, INOUT p_material integer, IN p_teacher integer, INOUT p_date date, OUT new_lesson_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_create_material(IN p_name character varying, IN p_desc text, IN p_link text, OUT new_material_id integer) TO superadmin;


--
-- TOC entry 5101 (class 0 OID 0)
-- Dependencies: 293
-- Name: PROCEDURE proc_create_parent(IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, OUT new_parent_id integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON PROCEDURE public.proc_create_parent(IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, OUT new_parent_id integer) TO admin;
GRANT ALL ON PROCEDURE public.proc_create_parent(IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, OUT new_parent_id integer) TO superadmin;


--
-- TOC entry 5102 (class 0 OID 0)
-- Dependencies: 290
-- Name: PROCEDURE proc_create_student(IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, IN p_class character varying, OUT new_student_id integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON PROCEDURE public.proc_create_student(IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, IN p_class character varying, OUT new_student_id integer) TO admin;
GRANT ALL ON PROCEDURE public.proc_create_student(IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, IN p_class character varying, OUT new_student_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_create_studentdata(IN p_journal_id integer, IN p_student_id integer, IN p_lesson integer, IN p_mark smallint, IN p_status public.journal_status_enum, INOUT p_note text, OUT new_data_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_create_teacher(IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, OUT new_teacher_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_create_user(IN p_username character varying, IN p_email character varying, IN p_password character varying, OUT new_user_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_delete_day(IN p_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_delete_homework(IN p_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_delete_lesson(IN p_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_delete_parent(IN p_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_delete_student(IN p_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_delete_studentdata(IN p_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_delete_user(IN p_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_remove_role_from_user(IN p_user_id integer, IN p_role_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_reset_user_password(IN p_user_id integer, IN p_new_password character varying) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_unassign_student_parent(IN p_student_id integer, IN p_parent_id integer) TO superadmin;


--
-- TOC entry 5116 (class 0 OID 0)
-- Dependencies: 312
-- Name: PROCEDURE proc_update_day(IN p_id integer, IN p_name character varying, IN p_time time without time zone, IN p_weekday character varying); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON PROCEDURE public.proc_update_day(IN p_id integer, IN p_name character varying, IN p_time time without time zone, IN p_weekday character varying) TO admin;
GRANT ALL ON PROCEDURE public.proc_update_day(IN p_id integer, IN p_name character varying, IN p_time time without time zone, IN p_weekday character varying) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_update_homework(IN p_id integer, IN p_name character varying, IN p_teacher integer, IN p_lesson integer, IN p_duedate date, IN p_desc text, IN p_class character varying) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_update_lesson(IN p_lesson_id integer, IN p_name character varying, IN p_class character varying, IN p_subject integer, IN p_material integer, IN p_teacher integer, IN p_date date) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_update_material(IN p_id integer, IN p_name character varying, IN p_desc text, IN p_link text) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_update_parent(IN p_id integer, IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_update_student(IN p_id integer, IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer, IN p_class character varying) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_update_studentdata(IN p_id integer, IN p_journal_id integer, IN p_student_id integer, IN p_lesson integer, IN p_mark smallint, IN p_status public.journal_status_enum, IN p_note text) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_update_teacher(IN p_id integer, IN p_name character varying, IN p_surname character varying, IN p_patronym character varying, IN p_phone character varying, IN p_user_id integer) TO superadmin;
...
GRANT ALL ON PROCEDURE public.proc_update_user(IN p_id integer, IN p_username character varying, IN p_email character varying, IN p_password character varying) TO superadmin;
...
GRANT ALL ON TABLE public.class TO superadmin;
...
GRANT ALL ON TABLE public.days TO superadmin;
...
GRANT ALL ON TABLE public.homework TO superadmin;


--
-- TOC entry 5128 (class 0 OID 0)
-- Dependencies: 222
-- Name: TABLE homework_tomorrow; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.homework_tomorrow TO admin;
GRANT ALL ON TABLE public.homework_tomorrow TO superadmin;
...
GRANT ALL ON TABLE public.journal TO superadmin;
...
GRANT ALL ON TABLE public.lessons TO superadmin;
...
GRANT ALL ON TABLE public.material TO superadmin;
...
GRANT ALL ON TABLE public.parents TO superadmin;
...
GRANT ALL ON TABLE public.studentdata TO superadmin;
...
GRANT ALL ON TABLE public.studentparent TO superadmin;
...
GRANT ALL ON TABLE public.students TO superadmin;


--
-- TOC entry 5137 (class 0 OID 0)
-- Dependencies: 237
-- Name: TABLE students_avg_above_7; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.students_avg_above_7 TO admin;
GRANT ALL ON TABLE public.students_avg_above_7 TO superadmin;


--
-- TOC entry 5138 (class 0 OID 0)
-- Dependencies: 238
-- Name: TABLE students_by_class; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.students_by_class TO admin;
GRANT ALL ON TABLE public.students_by_class TO superadmin;
...
GRANT ALL ON TABLE public.subjects TO superadmin;
...
GRANT ALL ON TABLE public.teacher TO superadmin;


--
-- TOC entry 5141 (class 0 OID 0)
-- Dependencies: 244
-- Name: TABLE teachers_with_classes; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.teachers_with_classes TO admin;
GRANT ALL ON TABLE public.teachers_with_classes TO superadmin;
...
GRANT ALL ON TABLE public.timetable TO superadmin;
...
GRANT ALL ON TABLE public.userrole TO superadmin;
...
GRANT ALL ON TABLE public.vw_class_attendance_last_month TO superadmin;
...
GRANT ALL ON TABLE public.vw_class_ranking TO superadmin;
...
GRANT ALL ON TABLE public.vw_homework_tomorrow TO superadmin;
...
GRANT ALL ON TABLE public.vw_students_avg_above_7 TO superadmin;
...
GRANT ALL ON TABLE public.vw_students_by_class TO superadmin;


-- Completed on 2025-12-18 20:15:19

--
-- PostgreSQL database dump complete
--

\unrestrict Cdp7ZaKkeew7cmL0MoEf7NxAra8ukLtkdzlEbKuKAlGMy1qWGTbQPh6Q48TAcuA
